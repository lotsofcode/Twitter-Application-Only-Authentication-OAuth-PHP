...
define('CONSUMER_KEY', 'TBA');
define('CONSUMER_SECRET', 'TBA');
/**
...
* Based on https://dev.twitter.com/docs/api/1.1/get/search/tweets
*/
function get_timeline($bearer_token, $query, $result_type='mixed', $count='15'){
...
// echo '<pre>';
print_r(get_timeline($bearer_token, "lotsofcode")); //  search for the work 'test'
